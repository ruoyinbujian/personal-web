...
tab:function(obj,fn){
	...
	var cont=obj.getElementsByClassName('tabCont')[0];
	
	//选项卡
	for(var i=0;i<aLi.length;i++){
		cont.innerHTML='<div class="boxplus" id="boxplus">'+'<img src="images/kelaibi3.jpg">'+'<span id="boxspan"></span>'+'</div><div class="b_boxplus" id="b_boxplus">'+'<img class="bigImg" id="bigImg" src="images/datu3.jpg"></div>';
		aLi[i].index=i;		
		aLi[i].onmousemove=function(){
			...
			var attr=this.getAttribute('data-cont');
			fn && fn(attr,cont);
		};	
	};	
},
...
function offsetLeft( elm ){ 
	...
	var oDiv1=document.getElementById('plusbox');
	var oDiv2=document.getElementById('b_boxplus');
